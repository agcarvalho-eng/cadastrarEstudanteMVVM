...
import com.example.cadastrarEstudanteMVVM.view.EstudantesAdapter.OnItemClickListener;
...
public class BindingAdapter {
    ...
    @androidx.databinding.BindingAdapter("app:items")
    ...
    @androidx.databinding.BindingAdapter("app:itemClickListener")
